...
วันนี้ผมขอนำเสนอ **"Standard Protocol"** สำหรับการขึ้นโปรเจกต์ Vue.js ใหม่ ที่รับรองว่า Setup ทีเดียวจบ ครบตั้งแต่นิ้วกด Save ยันโค้ดขึ้น Cloud โดยใช้พลังของ **@antfu/eslint-config** ของ Anthony Fu (Core Team Vue/Vite) ที่รวบรวม Best Practices มาไว้ให้เราแล้ว สะดวกสุดๆ

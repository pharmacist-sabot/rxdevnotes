...
pubDate: '2025-12-08'
heroImage: './eslint-antfu-setup.png'
...
แต่ถ้าใครไม่อยากตั้งค่าเอง 555 ผมได้ทำ <a href="https://github.com/suradet-ps/vue-starter" target="_blank" rel="noopener noreferrer"><code>**vue-starter**</code></a> ซึ่งเป็น template ที่มีการตั้งค่า Standard Protocol แล้ว โดยใช้ Vue3 + TypeScript + TailwindCSS ถ้าใครอยากนำไปใช้ก็กดที่ Use this template ได้เลยครับ
